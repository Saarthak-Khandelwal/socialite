...
--
-- Host: localhost    Database: socialite
-- ------------------------------------------------------
...
CREATE TABLE `rdetails` (
  ...
  `ratingo` decimal(3,1) DEFAULT NULL,
  `starttime` time DEFAULT NULL,
  `mlink` varchar(200) DEFAULT NULL,
  `rpno` varchar(10) DEFAULT NULL,
...
-- Dump completed on 2023-03-05 16:35:38
